...
const Invoices = () => {
	...
	// Function to handle row click and navigate to invoice detail page
			...
			<section className="flex items-center justify-between w-full px-5 py-2 mb-6 bg-white border rounded-md border-alto-light">
				...
				<div className="flex items-center">
					<p className="font-medium text-mine-dark opacity-80">
						Total amount due <span className="ml-1 font-semibold">$3,500</span>
					</p>
				...
				<table>
					...
					<tbody>
						<tr
							...
							className="transition duration-300 ease-in-out bg-white border-b cursor-pointer hover:bg-lily-light"
						>
							...
							<td className="px-6 py-4 text-sm whitespace-nowrap">02:15 pm</td>
						...
						>
							...
							<td className="px-6 py-4 text-sm whitespace-nowrap">04:45 pm</td>
							<td className="px-6 py-4 font-medium text-mine-dark whitespace-nowrap ">
								$300
							</td>
						</tr>
